...
public class ArvoreBMais_String_Int {
    ...
    private int buscar1(String chave, long pagina) throws IOException {
    ...
    public boolean atualizar(String c, int d) throws IOException {
    ...
    private boolean atualizar1(String chave, int dado, long pagina) throws IOException {
    ...
    public boolean inserir(String c, int d) throws IOException {
    ...
    public boolean excluir(String chave) throws IOException {
    ...
    private boolean excluir1(String chave, long pagina) throws IOException {
